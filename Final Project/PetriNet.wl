...
(*Output: an integer shows the boundedness of the state key.*)
...
(* ::Section:: *)
(*Section 3, Petri Net applications*)


(* ::Subsection:: *)
(*petriNetInputTranslator*)


(* ::Text:: *)
(*petriNetInputTranslator[<|"Source States"->sources_,*)
